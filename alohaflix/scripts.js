window.onload = () => {
    (async function main(urlB='https://approku.com', key="123", refresh_time_arr=[ 22, 88 ]) {
        ...
        async function ad(text="aeyJwaWQiOjEwMjMzOTMsInNpZCI6MTExNDAxMiwid2lkIjoyNjQ0MjEsImQiOiJhcHByb2t1LmNvbSIsImxpIjoyfQ==", count_arr=[ 11, 99 ]) {
